...
void sqlite3_vector_use_type_backend::pre_use(indicator const * ind)
{
    ...
    for (size_t i = 0; i != vsize; ++i)
    {
		...
		sqlite3_column& column = statement_.useData_[i][pos];
